...
window.FONTANA_CONFIG = {
  ...
  // Catálogo inicial para desarrollo y recuperación explícita. En producción,
  // la fuente de verdad es el catálogo publicado desde el panel privado.
  ...
  dynamicCatalog: [
    ...
    {
      id: "bottega-de-cecco-tortiglioni",
      category: "bottega",
      brand: "De Cecco",
      name: "De Cecco Tortiglioni Senza Glutine",
      price: 10,
      image: "assets/bottega/de-cecco-tortiglioni-fontana.jpg",
      description: "Pasta tortiglioni hecha de maíz, arroz integral y papa.",
      ingredients: "Maíz, arroz integral y papa.",
      weight: "400 G",
    ...
    {
      id: "bottega-de-cecco-penne-rigate",
      category: "bottega",
      brand: "De Cecco",
      name: "De Cecco Penne Rigate Senza Glutine",
      price: 10,
      image: "assets/bottega/de-cecco-penne-rigate-fontana.jpg",
      description: "Pasta penne rigate hecha de maíz, arroz integral y papa.",
      ingredients: "Maíz, arroz integral y papa.",
      weight: "400 G",
      availabilityLabel: "DISPONIBILIDAD POR CONFIRMAR",
      glutenFree: true,
    ...
    {
      id: "bottega-de-cecco-linguine",
      category: "bottega",
      brand: "De Cecco",
      name: "De Cecco Linguine Senza Glutine",
      price: 10,
      image: "assets/bottega/de-cecco-linguine-fontana.jpg",
      description: "Pasta linguine hecha de maíz, arroz integral y papa.",
      ingredients: "Maíz, arroz integral y papa.",
      weight: "400 G",
      availabilityLabel: "DISPONIBILIDAD POR CONFIRMAR",
      glutenFree: true,
    ...
    {
      id: "bottega-de-cecco-aceite-oliva-classico",
      category: "bottega",
      brand: "De Cecco",
      name: "De Cecco Aceite de Oliva Extra Virgen Classico",
      price: 10,
      image: "assets/bottega/de-cecco-aceite-oliva-classico-fontana.jpg",
      description: "Aceite de oliva extra virgen clásico.",
      ingredients: "Olivas.",
      weight: "500 ML",
      availabilityLabel: "DISPONIBILIDAD POR CONFIRMAR",
      glutenFree: true,
    ...
    {
      id: "bottega-pecorino-romano-dop",
      category: "bottega",
      name: "Pecorino Romano DOP",
      price: 10,
      image: "assets/bottega/pecorino-romano-dop-fontana.jpg",
      description: "Queso Pecorino Romano con denominación de origen protegida.",
      ingredients: "Leche de oveja y sal.",
      weight: "PRESENTACIÓN POR CONFIRMAR",
      availabilityLabel: "DISPONIBILIDAD POR CONFIRMAR",
      glutenFree: true,
      sugarFree: true,
      lactoseFree: true,
    ...
    {
      id: "bottega-provolone-valpadana-piccante",
      category: "bottega",
      name: "Provolone Valpadana Piccante",
      price: 10,
      image: "assets/bottega/provolone-valpadana-piccante-fontana.jpg",
      description: "Queso Provolone Valpadana de sabor picante.",
      ingredients: "Leche y sal.",
      weight: "PRESENTACIÓN POR CONFIRMAR",
      availabilityLabel: "DISPONIBILIDAD POR CONFIRMAR",
      glutenFree: true,
      sugarFree: false,
    ...
    {
      id: "bottega-apetina-tomates-secos",
      category: "bottega",
      brand: "Apetina",
      name: "Apetina con Tomates Secos",
      price: 10,
      image: "assets/bottega/apetina-tomates-secos-fontana.jpg",
      description: "Queso blanco en aceite con tomates secos.",
      ingredients: "Leche, sal, tomates secos y aceite.",
      weight: "PRESENTACIÓN POR CONFIRMAR",
      availabilityLabel: "DISPONIBILIDAD POR CONFIRMAR",
      glutenFree: true,
      sugarFree: true,
    ...
    {
      id: "bottega-apetina-feta-aceitunas-negras",
      category: "bottega",
      brand: "Apetina",
      name: "Apetina Feta con Aceitunas Negras",
      price: 10,
      image: "assets/bottega/apetina-feta-aceitunas-negras-fontana.jpg",
      description: "Feta en aceite con aceitunas negras.",
      ingredients: "Leche, sal, aceitunas y aceite.",
      weight: "100 G",
      availabilityLabel: "DISPONIBILIDAD POR CONFIRMAR",
      glutenFree: true,
      sugarFree: true,
    ...
    {
      id: "bottega-arla-lactofree-queso-fresco",
      category: "bottega",
      brand: "Arla",
      name: "Arla Lactofree Queso Fresco",
      price: 10,
      image: "assets/bottega/arla-lactofree-queso-fresco-fontana.jpg",
      description: "Queso fresco elaborado con leche deslactosada.",
      ingredients: "Leche deslactosada.",
      weight: "PRESENTACIÓN POR CONFIRMAR",
      availabilityLabel: "DISPONIBILIDAD POR CONFIRMAR",
      glutenFree: true,
      sugarFree: true,
    ...
    {
      id: "bottega-cirio-passata",
      category: "bottega",
      brand: "Cirio",
      name: "Cirio Passata",
      price: 10,
      image: "assets/bottega/cirio-passata-fontana.jpg",
      description: "Tomate tamizado tipo passata.",
      ingredients: "Tomates.",
      weight: "PRESENTACIÓN POR CONFIRMAR",
      availabilityLabel: "DISPONIBILIDAD POR CONFIRMAR",
      glutenFree: true,
    ...
    {
      id: "bottega-barilla-pesto-sin-ajo",
      category: "bottega",
      brand: "Barilla",
      name: "Barilla Pesto Genovese sin Ajo",
      price: 10,
      image: "assets/bottega/barilla-pesto-sin-ajo-fontana.jpg",
      description: "Pesto genovés sin ajo.",
      ingredients: "Albahaca, Grana Padano, aceite y sal.",
      weight: "PRESENTACIÓN POR CONFIRMAR",
      availabilityLabel: "DISPONIBILIDAD POR CONFIRMAR",
      glutenFree: true,
      sugarFree: true,
  ...
  leadTimesByProduct: {
    ...
    fonkie: { minimumBusinessDays: 0, label: "Stock activo: disponibilidad inmediata. Sin stock: Pre-Order de 2 días" },
    "fonkie-mix": { minimumBusinessDays: 0, label: "Stock activo: disponibilidad inmediata. Sin stock: Pre-Order de 2 días" },
    "fonkie-box": { minimumBusinessDays: 0, label: "Stock activo: disponibilidad inmediata. Sin stock: Pre-Order de 2 días" },
    "fomb-box": { minimumBusinessDays: 0, label: "Stock activo: disponibilidad inmediata. Sin stock: Pre-Order de 2 días" },
    bombones: { minimumBusinessDays: 0, label: "Stock activo: disponibilidad inmediata. Sin stock: Pre-Order de 2 días" },
    "bombones-12": { minimumBusinessDays: 0, label: "Stock activo: disponibilidad inmediata. Sin stock: Pre-Order de 2 días" },
    ...
    "cachito-fit": { minimumBusinessDays: 0, label: "Stock activo: disponibilidad inmediata. Sin stock: Pre-Order de 2 días" },
    panzerottis: { minimumBusinessDays: 0, label: "Stock activo: disponibilidad inmediata. Sin stock: Pre-Order de 2 días" },
    "tequenos-fit": { minimumBusinessDays: 0, label: "Stock activo: disponibilidad inmediata. Sin stock: Pre-Order de 2 días" },
    raviolis: { minimumBusinessDays: 0, label: "Stock activo: disponibilidad inmediata. Sin stock: Pre-Order de 2 días" },
    "nuggets-rora": { minimumBusinessDays: 0, label: "Stock activo: disponibilidad inmediata. Sin stock: Pre-Order de 2 días" },
